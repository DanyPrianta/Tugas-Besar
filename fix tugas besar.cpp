...
public:
 		 ...
 		 void Exit()
       {
		...
		//void Edit(char www[50],int xxx,char yyy[2],char zzz[50], int pos);
...
void antrian::jam()
{
  ...
  chgcolor(10);
  //cout<< "%s"<< asctime<<( waktu );
}
/*void antrian::Edit(char inama[50],int iumur,char isex[2],char ialamat[50],int pos )
...
void antrian::menu()
{
  ...
  cout<<char(188);
    ...
    cout << char( 202 );
      ...
      gotoxy( 610, 30 );
      cout<<endl;
      cout<<"KELOMPOK "<<endl<<endl;
      cout<<"1. Aditya Wijayanto 070"<<endl;
	  cout<<"2. Dea Aghata 076"<<endl;
	  cout<<"3. Dani Prianta 119"<<endl;
	  cout<<"4. Seto Pulung Bawono 094"<<endl<<endl;
  ...
  for ( int i = 5; i <= 7;i++ )
  {
   ...
   for ( int i = 5; i <= 7;i++ )
    ...
    switch ( pil )
    {
      ...
      /*case 5:
      	cout<<"Pilih data berapa yang ingin dirubah : ";cin>>posisi;
      	cout<<"Silahkan Input Data Yang Baru "<<endl;
      	cout<<"nama : ";cin>>www[50];
      	cout<<"umur : ";cin>>xxx;
      	cout<<"gender : ";cin>>yyy[2];
      	cout<<"alamat : ";cin>>zzz[50];
      Edit(www[50],xxx,yyy[2],zzz[50],posisi);break; */
      case 6:
      	Exit();break;
